...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{large_depts <-}\StringTok{ }\NormalTok{chicago_salaries[chicago_salaries}\OperatorTok{$}\NormalTok{Department }\OperatorTok{%in%}\StringTok{ }\NormalTok{large_dept_names, ]}
